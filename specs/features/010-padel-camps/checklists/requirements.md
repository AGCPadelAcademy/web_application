...
- `/speckit-analyze` remediation (2026-09-08) resolved all MEDIUM findings: `billing_operations.kind` CHECK extension decided (I1), `camp_funnel_events` storage decided (A1), `guard_camp_waitlist_join` trigger added (U1), emergency contact required at submit (A2), shared-file parallel claim corrected (I2), mobile-viewport checks added (U2). LOW findings D1/A3/A4/I4/I5 were clarified in place; I3 (FR sub-letter numbering) is accepted as-is.
