...
- **FR-006a**: A parent MUST be able to have more than one child. The parent MUST have a Children page that lists only their children, lets them add a child, and lets them view and update each child’s personal information: first name, last name, date of birth, padel level/experience, allergies/important information, and emergency contact. Emergency contact MAY be empty on the stored child record; it becomes required at registration submit (FR-007).
